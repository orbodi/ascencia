...
const paths: Record<string, React.ReactNode> = {
  ...
  levels: <><path d="m3 9 9-5 9 5-9 5z"/><path d="m7 12v5c3 2 7 2 10 0v-5"/></>,
  teachers: <><circle cx="9" cy="8" r="4"/><path d="M2 21a7 7 0 0 1 14 0M17 11h5M19.5 8.5v5"/></>,
  groups: <><circle cx="9" cy="8" r="3"/><circle cx="17" cy="9" r="2.5"/><path d="M3 20a6 6 0 0 1 12 0M14 15a5 5 0 0 1 8 4"/></>,
  rooms: <><path d="M3 21V5l9-3v19M12 7h9v14M7 8h1M7 12h1M7 16h1M16 11h1M16 15h1"/></>,
  courses: <><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V3H6.5A2.5 2.5 0 0 0 4 5.5z"/><path d="M4 5.5v14"/></>,
  curriculum: <><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/></>,
